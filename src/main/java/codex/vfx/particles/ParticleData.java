...
/**
 * Main implementation of {@link Particle} which adds many useful properties.
 * <p>
 * Most, if not all, prebuilt functionality in this library will use this
 * implementation.
 * 
 * @author codex
 */
public class ParticleData extends Particle {
     ...
     * <p>
     * Between 0, which is the upper left corner of the sprite sheet, and the number
     * of total units on the sprite sheet minus one.
     * <p>
     * For a 4x4 sprite sheet (16 units), the index must be between 0 and 15
     * (inclusive).
     */
