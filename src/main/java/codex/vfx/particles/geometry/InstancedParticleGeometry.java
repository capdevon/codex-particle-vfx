...
public class InstancedParticleGeometry extends ParticleGeometry<ParticleData> {
    ...
    protected void initBuffers() {
        ...
        VertexBuffer ivb = MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.InstanceData,
                VertexBuffer.Usage.Stream, VertexBuffer.Format.Float, ib, 16);
        ivb.setInstanced(true);
        if (writeColors) {
            FloatBuffer cb = BufferUtils.createFloatBuffer(capacity * 4);
            VertexBuffer cvb = MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.Color,
                    VertexBuffer.Usage.Stream, VertexBuffer.Format.Float, cb, 4);
