...
public class TriParticleGeometry extends ParticleGeometry<ParticleData> {
    ...
    protected void initBuffers() {
        ...
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.TexCoord2, VertexBuffer.Usage.Stream,
                VertexBuffer.Format.Float, pb2, 2);
        ...
        tb.flip();
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.TexCoord, VertexBuffer.Usage.Static,
                VertexBuffer.Format.Float, tb, 2);

        // sprite factions buffer
        ShortBuffer sib = BufferUtils.createShortBuffer(capacity * prototype.getNumVerts());
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.TexCoord3, VertexBuffer.Usage.Stream,
                VertexBuffer.Format.UnsignedShort, sib, 1);

        // Color buffer, including alpha.
        FloatBuffer cb = BufferUtils.createFloatBuffer(capacity * prototype.getNumVerts() * 4);
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.Color, VertexBuffer.Usage.Stream,
        ...
        MeshUtils.initializeVertexBuffer(mesh, VertexBuffer.Type.Index, VertexBuffer.Usage.Dynamic,
                VertexBuffer.Format.UnsignedShort, ib, 3);
