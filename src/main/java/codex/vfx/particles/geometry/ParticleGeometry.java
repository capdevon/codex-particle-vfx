...
public abstract class ParticleGeometry<T extends Particle> extends Geometry {
    ...
    protected static final BoundingSphere INFINITE_BOUND = new BoundingSphere(Float.POSITIVE_INFINITY, Vector3f.ZERO);
     ...
     * <p>
     * If the particle group is paused, the mesh would normally not be updated,
     * since all particles are assumed to be static. If, for some reason, the
     * particles are not static in this state, setting this to true will force this
     * geometry to always update the mesh.
     * <p>
     * default=false
     * 
     ...
     * <p>
     * This must be enabled to support sprite sheets. Otherwise geometries will not
     * write particle sprite indices to their meshes.
     * <p>
     * default=false
     * 
     * @param enable
